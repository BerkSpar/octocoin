...
class MockSearchRepository extends _i1.Mock implements _i3.SearchRepository {
  ...
  _i4.Future<_i2.Either<Exception, List<_i5.Market>>> getMarkets(
      ...
      (super.noSuchMethod(
          ...
          returnValue: Future<_i2.Either<Exception, List<_i5.Market>>>.value(
              _FakeEither_0<Exception, List<_i5.Market>>())) as _i4
          .Future<_i2.Either<Exception, List<_i5.Market>>>);
}
